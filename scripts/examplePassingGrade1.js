...
let gradeinputvalues = grade_array.join(" , ");

for(let var1 of grade_array) {
    let grade = parseFloat(var1);
    output_string = "Input Grade: " + grade + "</br>";
    if (grade < 0 || grade > 100 || isNaN(grade)) {
        output_string += "Wrong Format</br>";
    } else
    {
        if (grade >= passing_grade)
        {
        ...
        output_string += "Grade Type: " + grade_type + "</br>";
        ...
        output_string += "Total passed grade: " + total_passed_grade_count + "</br>";
        output_string += "Total failed grade: " + total_failed_grade_count + "</br>";
        output_string += "Total grade count: " + total_grade_count + "</br>";
        output_string += "Total grade: " + total_grade + "</br>";
        output_string += "Average grade: " + average_grade + "</br>";
